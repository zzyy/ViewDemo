...
public class AppBarLayoutSpringBehavior extends AppBarLayout.Behavior {
    ...
    public boolean onStartNestedScroll(CoordinatorLayout parent, AppBarLayout child, View directTargetChild, View target, int nestedScrollAxes) {
        ...
        Logger.i(">>>onStartNestedScroll result=" + started);
        return started;
    }
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout abl, View target) {
        ...
        Logger.i(">>>> onStopNestedScroll");
    }

   /* @Override
    public boolean onNestedFling(final CoordinatorLayout coordinatorLayout,
                                 final AppBarLayout child, final View target, float velocityX, float velocityY,
                                 boolean consumed) {
        ...
        if (!consumed) {
            ...
            target.getViewTreeObserver().addOnScrollChangedListener(new ViewTreeObserver.OnScrollChangedListener() {
                ...
                public void onScrollChanged() {
                    Logger.w("<<<< scroll;" + target.getScrollY());
                }
            });
...
//        target.getViewTreeObserver().
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout,
        ...
        Logger.w( "==== newOffset=" + newOffset +" minOffset=" + minOffset + " maxOffset=" + maxOffset  + " currOffset=" + curOffset);
        int consumed = 0;
